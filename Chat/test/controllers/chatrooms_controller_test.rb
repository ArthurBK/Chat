...
class ChatroomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create chatroom" do
    assert_difference('Chatroom.count') do
      post chatrooms_url, params: { chatroom: { name: @chatroom.name, user_id: @chatroom.user_id } }
    end
  ...
  test "should update chatroom" do
    patch chatroom_url(@chatroom), params: { chatroom: { name: @chatroom.name, user_id: @chatroom.user_id } }
